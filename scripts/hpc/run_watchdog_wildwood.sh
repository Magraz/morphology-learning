...
SCRATCH=/home/coe/agrazvam/tmp
SCRIPT=/home/coe/agrazvam/morphology-learning/scripts/hpc/watchdog_loop.py
...
#SBATCH --partition=pelican,baggins                                                  # name of partition or queue
