...
sbatch <<EOT
#!/bin/bash
#SBATCH -J ${TRIAL_ID}_${EXPERIMENT_NAME}_${ALGORITHM}_${BATCH_NAME}_evaluate         # name of job
...
#SBATCH -o ./logs/${BATCH_NAME}_${EXPERIMENT_NAME}_${TRIAL_ID}_evaluate.out           # name of output file for this submission script
#SBATCH -e ./logs/${BATCH_NAME}_${EXPERIMENT_NAME}_${TRIAL_ID}_evaluate.err           # name of error file for this submission script
...
DISPLAY=":0" python3 $EXPERIMENT_SCRIPT --batch $BATCH_NAME --name $EXPERIMENT_NAME --algorithm $ALGORITHM --environment $ENVIRONMENT --trial_id $TRIAL_ID --evaluate
EOT
